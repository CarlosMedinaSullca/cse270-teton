...
class TestSmokeTest():
  ...
  def test_adminpage(self):
    ...
    self.driver.set_window_size(1227, 725)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".myinput:nth-child(2)").text == "Username:"
    self.driver.find_element(By.ID, "username").send_keys("anything")
    self.driver.find_element(By.ID, "password").send_keys("dfadf")
  ...
  def test_directorypage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1180, 725)
  ...
  def test_homepage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(954, 910)
  ...
  def test_joinpage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1158, 725)
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Terra")
